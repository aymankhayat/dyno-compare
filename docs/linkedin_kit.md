...
- Units. One conversion module and 32 automated tests. The GR Supra's computed weight-to-power is 8.90 lb/hp; Toyota publishes 8.89.
- The cars. Six real 3D models, compressed from 135 MB to 19 MB and scaled in code to each car's published length.
...
- 6 real 3D car models (credited Sketchfab artists), compressed from 135 MB to 19 MB with meshopt and WebP and scaled to published dimensions.
...
- 32 automated tests, including unit conversions (60 mph = 96.6 km/h, 300 hp = 224 kW) and a power-to-weight check within 0.01 lb/hp of Toyota's published GR Supra figure.
...
- Validated derived metrics against OEM data, matching Toyota's published GR Supra weight-to-power ratio within 0.01 lb/hp, backed by 32 automated tests.
...
### Software / front-end
- Built and deployed a static three.js and SVG web app with no build step: 6 real 3D car models compressed from 135 MB to 19 MB and scaled in code to published dimensions, shareable URL state and a mobile-safe 3D stage that pauses rendering off-screen.
- Wrote a 32-test browser suite covering unit conversions, data integrity and URL state; live at aymankhayat.github.io/dyno-compare.

### General mechanical engineering
- Designed and built Dyno Compare, a 3D vehicle comparison site with 9 cars, 45 sourced specifications and 32 automated tests, explaining the engineering behind turbocharging, drivetrain layout and hybrid systems; live at aymankhayat.github.io/dyno-compare.
